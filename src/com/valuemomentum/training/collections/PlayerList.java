...
public class PlayerList {
	...
	PlayerList()
	{
		...
		playerArray=new ArrayList(); //object creation
...
void add()
{
	...
	{
		playerArray.add(new Integer(ctr));  // in non generic we can add numbers and strings
	}
...
{
	System.out.println("**********************" + "***********************");
	System.out.println("extract is a sublist and " + "then print the new list");
	System.out.println("**********************" + "*********************");
	System.out.println();
